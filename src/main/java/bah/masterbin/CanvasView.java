...
public class CanvasView extends View {
    ...
    public static RectangleListner rectangleListner;
    ...
    public static void setRectangleListner(Context context)
    {
        rectangleListner= (RectangleListner) context;
    }
    ...
    private void onActionUp(MotionEvent event) {
        ...
        if(rectangleListner!=null){
            rectangleListner.onRectangleDrawn(this.startX,this.startY,event.getX(),event.getY());
           // Rect rect=new Rect((int)startX,(int)startY,(int)event.getX(),(int)event.getY());
           // drawWidthHeight(rect.width()+"",rect.height()+"",this.startX,this.startY);
            //this.canvas.drawText("Width",(int)this.startX,(int)this.startY,event.getX(),event.getY(),textPaint);
        }
 ...
 /*
    ...
    public interface RectangleListner{
